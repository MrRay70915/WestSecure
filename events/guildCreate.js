...
module.exports = async (client, guild) => {
    ...
    const hasData = client.WestSecure.lookUp(guild)
    if (!hasData){
      client.WestSecure.create(guild.id)
    }
    ...
    client.channels.cache.get(client.config.logChannel).send({embeds: [guildCreateEmbed]});
  };